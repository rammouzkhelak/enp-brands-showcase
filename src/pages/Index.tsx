          ...
          <div className="max-w-4xl ml-0 md:ml-16 animate-fade-in">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-8 md:mb-12">
              ...
              <div className="md:ml-8">
                <Link to="/portfolio">
                  <div className="scale-75 md:scale-100 origin-left">
                    <CircularButton text="VIEW OUR PORTFOLIO • VIEW OUR PORTFOLIO • " />
                  </div>
                </Link>
              </div>
            </div>
            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 justify-items-center">
                <div className="group relative overflow-hidden rounded-lg shadow-lg cursor-pointer h-80 animate-fade-in">
                  <img src={trueBotanicalsImg} alt="True Botanicals" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                ...
                <div className="group relative overflow-hidden rounded-lg shadow-lg cursor-pointer h-80 animate-fade-in" style={{
                animationDelay: '0.1s'
              }}>
                  <img src={instacartImg} alt="Instacart" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition-all duration-300"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform transition-all duration-300 group-hover:-translate-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center">
                <div className="group relative overflow-hidden rounded-lg shadow-lg cursor-pointer h-64 animate-fade-in" style={{
                animationDelay: '0.2s'
              }}>
                  <img src={nutrafolImg} alt="Nutrafol" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition-all duration-300"></div>
                ...
                animationDelay: '0.3s'
                  ...
                  <img src={frankBodyImg} alt="Frank Body" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition-all duration-300"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white transform transition-all duration-300 group-hover:-translate-y-2">
                ...
                animationDelay: '0.4s'
                  ...
                  <img src={plumImg} alt="Plum" className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-black bg-opacity-40 group-hover:bg-opacity-50 transition-all duration-300"></div>
                  <div className="absolute bottom-0 left-0 right-0 p-4 text-white transform transition-all duration-300 group-hover:-translate-y-2">
            ...
            <div className="flex justify-center">
              <Link to="/contact">
                <div className="scale-75 md:scale-100">
                  <CircularButton text="GET IN TOUCH • GET IN TOUCH • GET IN TOUCH • " />
                </div>
              </Link>
            </div>
          </div>
